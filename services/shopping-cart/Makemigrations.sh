...
if [ "$1" = "--initial" ]; then
  ...
  if [ -d "ShoppingCart.Api/Data/Migrations" ]; then
    rm -rf ShoppingCart.Api/Data/Migrations/*
  ...
  dotnet ef migrations add InitialMigration --project ShoppingCart.Api --output-dir Data/Migrations
