...
if [ "$1" = "--initial" ]; then
  ...
  if [ -d "Orders.Infrastructure/Migrations" ]; then
    rm -rf Orders.Infrastructure/Migrations/*
  ...
  dotnet ef migrations add InitialMigration --project Orders.Infrastructure --startup-project Orders.Api
